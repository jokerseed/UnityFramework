...
{
    /// <summary>GAS 层：技能成功激活（表现/日志）。</summary>
    ...
    /// <summary>GAS 层：伤害成功结算（表现/UI）。</summary>
    ...
    /// <summary>GAS 层：伤害被免疫/护甲完全抵消（表现/UI）。</summary>
    ...
    /// <summary>GAS 层：属性变化通知（UI）。</summary>
    ...
    /// <summary>GAS 层：Tag 变化通知（UI/动画状态机）。</summary>
    ...
    /// <summary>表现层：GameplayCue（动画/特效/音效）。</summary>
