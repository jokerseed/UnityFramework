...
namespace Framework.Lockstep
{
    public abstract class AbstractLockstep
    {
        ...
        */
        ...
        ~AbstractLockstep()
        {
            //UnityEngine.Debug.Log("析构AbstractLockstep");
        }
        ...
        public void Clear()
        {
            ...
            playersDisconnect.Clear();
            _syncedDataCacheDrop = null;
            _syncedDataCacheUpdateData = null; 
            ...
            StepUpdate = null;
            localPlayer?.Clear();
            GetLocalData = null; // 获取本地数据

            InputDataProvider = null;
        ...
        private bool CheckDrop(TSPlayer p)
        {
            ...
            if (flag)
            {
                ...
                if (flag2)
                {
                    ...
                    this.UpdateActivePlayers();
                    //Log.Debug("Player dropped (stopped sending input)");
