// Migrated from D:\Client\Assets\Script\Core\TrueSync\Engine\Math (TrueSync FP / Fix64).
// Namespace retargeted to Framework.FixedMath; Obscured*/IWGames removed.
using System;
using System.IO;
...
namespace Framework.FixedMath {
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP> {
        ...
        public const long HUNDRED = 100L << FRACTIONAL_PLACES;
        public const long THOUSAND = 1000L << FRACTIONAL_PLACES;
        public const long TENTHOUSAND = 10000L << FRACTIONAL_PLACES;
        ...
        public static readonly FP NegativeOne = new FP(-ONE);
        public static readonly FP Ten = new FP(TEN);
        public static readonly FP Hundred = new FP(HUNDRED);
        public static readonly FP Thousand = new FP(THOUSAND);
        public static readonly FP TenThousand = new FP(TENTHOUSAND);
        ...
        /// <summary>
        /// Adds x and y. Note: despite the historical comment, this operator does <b>not</b> saturate;
        /// it wraps like two's-complement long add (same as Client TrueSync). Use <see cref="OverflowAdd"/> to saturate.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
