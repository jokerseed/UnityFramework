...
namespace Framework.Lockstep.Physics2D
{
    ...
    public static class LineTools
    {
        ...
        public static bool LineIntersect2(ref TSVector2 a0, ref TSVector2 a1, ref TSVector2 b0, ref  TSVector2 b1, out TSVector2 intersectionPoint)
        {
            ...
            //AABB early exit
            if (Framework.FixedMath.TSMath.Max(x1, x2) < Framework.FixedMath.TSMath.Min(x3, x4) || Framework.FixedMath.TSMath.Max(x3, x4) < Framework.FixedMath.TSMath.Min(x1, x2))
                return false;

            if (Framework.FixedMath.TSMath.Max(y1, y2) < Framework.FixedMath.TSMath.Min(y3, y4) || Framework.FixedMath.TSMath.Max(y3, y4) < Framework.FixedMath.TSMath.Min(y1, y2))
                return false;
