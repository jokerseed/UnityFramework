...
namespace Framework.Lockstep.Physics3D {
    ...
    **/
    public class RigidBody : IBroadphaseEntity, IDebugDrawable, IEquatable<RigidBody>, IComparable, IBody3D
    {
        ...
        public RigidBody()
        {
            //MemoryLeakDetector.Instance.TrackObject(this);
        }
        ...
        public RigidBody(Shape shape, BodyMaterial material,object parent)
            :this(shape,material,false, parent)
        {
        }
        ...
        public RigidBody(Shape shape, BodyMaterial material, bool isParticle,object parent)
        {
