...
namespace Framework.Lockstep.Physics3D {
	public partial class SoftBody : IBroadphaseEntity, IComparable
    {
        ...
        public class MassPoint : RigidBody
        {
            ...
            public MassPoint(Shape shape, SoftBody owner, BodyMaterial material,object parent)
                : base(shape, material, true, parent)
            {
                this.SoftBody = owner;
            }
        ...
        private void AddPointsAndSprings(List<TriangleVertexIndices> indices, List<TSVector> vertices)
        {
            ...
            {
                MassPoint point = new MassPoint(sphere, this,material,this);
